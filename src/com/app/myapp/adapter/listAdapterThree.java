...
public class listAdapterThree extends MyAdapter {
	//TAG
	private final String TAG = "com.app.androidapp.adapter.listAdapterThree";
	private List<User> list = new ArrayList<User>();
	private Context mContext;
	
	public listAdapterThree(Context _context) {
	...
	public class VisitorItemLayout extends RelativeLayout
	{
		...
		{
			super(context);
			((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.list_item3, this);
