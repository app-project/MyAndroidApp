...
public class listAdapterInfo extends MyAdapter {
	//TAG
	private final String TAG = "com.app.androidapp.adapter.listAdapterThree";
	private List<Information> list = new ArrayList<Information>();
	private Context mContext;
	
	public listAdapterInfo(Context _context) {
		this.mContext = _context;
	}
	
	public void setData(List<Information> _list)
	{
		list =  _list;
	}
	...
	public View getView(int pos, View v, ViewGroup p) {
		...
		try 
		{
			final Information object = list.get(pos);
			
			holder.title.setText(object.getTitle());
			//22  截取
			holder.content.setText(Helper.getString(object.getContent(),22));
			
			//net image loader
			if (object.getImage()!=null && !"".equals(object.getImage())) {
				//cache+network
				...
				loadImageNew(mContext,holder.image, object.getImage(),R.drawable.ic_launcher,100,100);
			}
		} catch (Exception e) {
